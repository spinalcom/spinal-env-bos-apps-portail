...
export enum MutationTypes {
	...
	SET_CONFIG_TEXT = 'SET_CONFIG_TEXT',
}
...
export type MutationsAppData<S = StateAppData> = {
	...
	[MutationTypes.SET_CONFIG_ENDPOINT](state: S, payload: string): void;
	[MutationTypes.SET_CONFIG_TEXT](state: S, payload: string): void;
}
...
export const mutations: MutationTree<StateAppData> & MutationsAppData = {
	...
	[MutationTypes.SET_CONFIG_ENDPOINT](state: StateAppData, payload: string): void {
		state.configEndpoint = payload;
	},
	[MutationTypes.SET_CONFIG_TEXT](state: StateAppData, payload: string): void {
		state.configText = payload;
	},
};
