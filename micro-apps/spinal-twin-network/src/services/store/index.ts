...
import { MutationTypes, MutationsAppData, mutations } from './appDataStore/mutations';
import { Actions, actions } from './appDataStore/actions';
import { getAppConfig, setWindowHook, subcribeAppConfigChange } from 'global-components/StoreConfig';
Vue.use(Vuex);
