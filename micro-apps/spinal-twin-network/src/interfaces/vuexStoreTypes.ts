...
export enum ActionTypes {
  ...
  GET_CHILDREN_BY_RELATION_CONTEXT = 'GET_CHILDREN_BY_RELATION_CONTEXT',
  GET_CHILDREN_BY_RELATION_MULTIPLE_CONTEXT = 'GET_CHILDREN_BY_RELATION_MULTIPLE_CONTEXT',
  ADD_COMPONENT_NETWORK_AS_SPRITE = 'ADD_COMPONENT_NETWORK_AS_SPRITE',
}
