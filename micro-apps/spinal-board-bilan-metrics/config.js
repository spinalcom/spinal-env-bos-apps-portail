...
module.exports = {
    title: "Bilan de l'occupation du bâtiment et de ses espaces spécifiques",
    fileName: 'bilan',
    unit: {
        default: false,
        left: {
        ...
        right: {
            name: '€',
            shortName: '€',
            icon: 'currency-eur', // visit this link to search for icons that work with this project https://v2.vuetifyjs.com/en/features/icon-fonts/#material-design-icons
        }
    },
    selectTitle: 'Donnée à analyser',
    calculs: ['Maximum', 'Minimum', 'Moyenne'],  // 'Maximum', 'Minimum', 'Moyenne', 'Somme'
    name: 'affluence_entree',
    controlEndpoint: 'affluence_entree',
    calendarLegend: "La journée où la consommation a été la plus importante est le ",
    stripLegend: "Le mois où la consommation a été la plus importante est ",
