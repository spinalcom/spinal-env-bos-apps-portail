    ...
    <div class="selectors">
      ...
      <div class="space">
        <space-selector v-if="config" ref="space-selector" :open.sync="openSpaceSelector" :maxDepth="2"
          ...
          :spaceSelectorItemButtons="spaceSelectorButtons" :viewButtonsType="configViewButtons"
          @onActionClick="onActionClick" />
      </div>
    </div>

    <div class="dataBody">
      <viewerApp v-if="config" class="viewerContainer" :class="{ active3D: isActive3D }"></viewerApp>
      <InsightApp v-if="config" class="appContainer" :DActive="isActive3D" :ActiveData="isActive"
