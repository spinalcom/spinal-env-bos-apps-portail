    ...
    <div v-if="isapp" class="blocAppStyle">
      ...
      <div class="container_cards">
        <div v-for="item in appTab" class="cardDescription">
          ...
          <div @click="() => {
            $emit('changeRoute', item.id, item.config);
          }" style="width: 100%;">
...
class dataSideApp extends Vue {
  ...
  async mounted() {
    ...
    if (this.selectedZone.type == "building" || window.parent.routerFontion.apps[0]._route.query.spaceSelectedId == this.buildingInfo[0].dynamicId) {
