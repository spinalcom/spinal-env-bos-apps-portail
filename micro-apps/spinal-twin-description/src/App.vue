...
<template>
  ...
  <v-app v-if="pageSate === PAGE_STATES.loaded" class="app">
    <div class="selectors">
      ...
      <div class="space">
        <space-selector v-if="config" ref="space-selector" :open.sync="openSpaceSelector" :maxDepth="2"
    ...
    <div class="dataBody">
      ...
      <dataSideApp v-if="config" :changeData="loadingdata" :floor="floor" :DActive="isActive3D" :ActiveData="isActive"
