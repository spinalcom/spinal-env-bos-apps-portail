...
import { ISpaceSelectorItem } from '../../interfaces/ISpaceSelectorItemItem';
...
class SpaceSelectorItem extends Vue {
  ...
  public get isSelected(): boolean {
    return this.item.staticId === this.selected?.staticId || this.selected?.parents?.includes(this.item.staticId);
  }
