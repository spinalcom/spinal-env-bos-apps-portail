...
import { MutationsAppData } from "../store/appDataStore/mutations";
import type { StateAppData } from "../store/appDataStore/state";
...
export type TFctViewerIteract = (stateContext: AugmentedActionContextAppData, payload: {  id: number | number[] }) => Promise<void>;
